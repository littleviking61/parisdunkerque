...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('large', 760, '', true); // Large Thumbnail
    add_image_size('medium', 300, '', true); // Medium Thumbnail
    add_image_size('small', 120, '', true); // Small Thumbnail
    add_image_size('big', 1280, 200, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
function html5blankgravatar ($avatar_defaults)
{
    ...
    $avatar_defaults[$myavatar] = "Cocoricogravatar Gravatar";
